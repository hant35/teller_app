...
@Getter
@Setter
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "id", scope = DepositType.class)
...
public class DepositType implements Serializable {
	...
	public DepositType(String id) {
		this.id = new Long(id);
	}

	@Id
	@SequenceGenerator(name = "ID_SEQUENCE_GENERATOR", sequenceName = "DEPOSIT_TYPE_SEQ")
	...
	public boolean equals(Object obj) {
		if (obj == null || !(obj instanceof DepositType))
			return false;
		if (this.getId() == null || ((DepositType) obj).getId() == null)
			return false;
		return this.getId().equals(((DepositType) obj).getId());
	}
