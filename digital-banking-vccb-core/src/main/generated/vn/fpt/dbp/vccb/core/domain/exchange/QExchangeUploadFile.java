...
/**
 * QExchangeUploadFile is a Querydsl query type for ExchangeUploadFile
 */
@Generated("com.querydsl.codegen.EntitySerializer")
public class QExchangeUploadFile extends EntityPathBase<ExchangeUploadFile> {

    private static final long serialVersionUID = 129188996L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QExchangeUploadFile exchangeUploadFile = new QExchangeUploadFile("exchangeUploadFile");
    ...
    public final SetPath<Exchange, QExchange> exchanges = this.<Exchange, QExchange>createSet("exchanges", Exchange.class, QExchange.class, PathInits.DIRECT2);
    ...
    public QExchangeUploadFile(String variable) {
        this(ExchangeUploadFile.class, forVariable(variable), INITS);
    }

    public QExchangeUploadFile(Path<? extends ExchangeUploadFile> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QExchangeUploadFile(PathMetadata metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QExchangeUploadFile(PathMetadata metadata, PathInits inits) {
        this(ExchangeUploadFile.class, metadata, inits);
    }

    public QExchangeUploadFile(Class<? extends ExchangeUploadFile> type, PathMetadata metadata, PathInits inits) {
