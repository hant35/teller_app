...
import vn.fpt.dbp.vccb.service.admin.service.EmailService;
...
public class EmailController {
    ...
    public String sendResetPasswordMail(Principal principle, @RequestBody User user) throws Exception {
        return emailService.sendEmail(user, "ResetPassword.vm", "TellerApp Reset Password");
    }
